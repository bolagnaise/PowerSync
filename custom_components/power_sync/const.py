...
CONF_TESLA_ENERGY_SITE_ID_2 = "tesla_energy_site_id_2"
CONF_TESLA_API_TOKEN_2 = "tesla_api_token_2"  # Only if secondary is on different Tesla account
CONF_TESLA_BATTERY_CAPACITY_1 = "tesla_battery_capacity_1"  # kWh
CONF_TESLA_BATTERY_CAPACITY_2 = "tesla_battery_capacity_2"  # kWh
DEFAULT_TESLA_BATTERY_CAPACITY = 13.5
